...
| 김태환 |DB를 활용한 프로젝트를 통해 많은 점을 얻은 것 같다. 쿼리문 작성 능력, 프로시저, 트리거 등 고급 sql문과 같은 것을 배우면서 sql에 대한 이해도 또한, 가질 수 있었다. 
그리고 팀프로젝트였어서 팀원과 안 맞으면 걱정했지만, 한 분 한 분이 너무 좋으신 분이고 의견 또한 잘 맞아서 막힘없이 결과를 만들 수 있었다. 감사합니다!|
