...
VALUES 
('고객님께서 만족하셨다니 기쁩니다. 앞으로도 최고의 서비스를 제공하겠습니다!', 1, 1),
('이사를 도와드리게 되어 정말 기쁩니다. 앞으로도 더 나은 서비스를 위해 노력하겠습니다.', 2, 2),
('부동산 상담을 도와드려 기쁩니다. 더 좋은 매물이 있을 경우 다시 찾아주세요.', 3, 1),
('인테리어 서비스가 만족스러우셨다니 감사합니다. 고객님을 위한 맞춤형 서비스를 제공하겠습니다.', 4, 3),
